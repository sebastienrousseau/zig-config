...
This document describes how @sebastienrousseau/zig-config is run: who decides what, how
...
@sebastienrousseau/zig-config is **maintainer-led**. As of the current release line it has a single
